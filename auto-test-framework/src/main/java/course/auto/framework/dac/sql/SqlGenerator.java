package course.auto.framework.dac.sql;

import com.google.common.base.Strings;
import course.auto.framework.model.GenSqlParams;
import course.auto.framework.model.StatementEntity;
...
public final class SqlGenerator {
    ...
    private static final String DELETE_SQL_TEMP = "delete from %s.%s where 1=1 %s";
    private static final String SELECT_SQL_TEMP = "select * from %s.%s where 1=1 %s";
